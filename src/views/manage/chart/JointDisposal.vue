<template>
  <div id="jointDisposal" style="height: calc(100%); width: 105%"></div>
</template>
<script>
import api from "../../../api";
...
export default {
  ...
  methods: {
    ...
    init() {
      let jointDisposalEcharts = this.$echarts.init(
        document.getElementById("jointDisposal")
      );
      let city = [
          "长春",
          "吉林",
      ...
      jointDisposalEcharts.setOption({
        //提示框
        tooltip: {
          show: true,
        },
